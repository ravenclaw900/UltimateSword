...
public enum ModArmorMaterial implements IArmorMaterial
{
    ...
    ULTIMATE(UltimateSword.MOD_ID + ":ultimate", 999999999, new int[] { 10, 15, 20, 10 }, 4, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3.0F, () -> {
        return Ingredient.fromItems(ModItems.ULTIMATE_SHARD.get());
    });
